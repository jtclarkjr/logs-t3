...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: scoped CSS variables for chart themes
...
function ChartTooltipContent({
  ...
  labelFormatter?: (value: unknown, payload: ChartDatum[]) => React.ReactNode;
